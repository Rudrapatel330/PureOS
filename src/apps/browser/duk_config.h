...
#define DUK_F_X64
#define DUK_F_GCC
#define DUK_USE_OS_STRING "pureos"
#define DUK_USE_BYTEORDER 1
#define DUK_USE_DATE_NOW_EMPTY
#define DUK_USE_DATE_TZO_EMPTY
#define DUK_USE_MALLOC(ud,sz) malloc(sz)
#define DUK_USE_REALLOC(ud,ptr,sz) realloc(ptr,sz)
#define DUK_USE_FREE(ud,ptr) free(ptr)

/* Aggressive Size Optimization */
#define DUK_USE_DEBUGGER_SUPPORT       // Disabled (default)
#define DUK_USE_PC2LINE               // Disable PC-to-line mapping (saves space)
#define DUK_USE_REGEXP_CANON_WORKAROUND
#define DUK_USE_VERBOSE_ERRORS        // Disable verbose error strings
#define DUK_USE_PARSER_STACK_CHECK
#define DUK_USE_ASSERTIONS             // No assertions in production

// Disable some complex features to ensure compilation
#define DUK_USE_SIGNAL_MANAGEMENT
