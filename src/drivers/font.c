...
const uint8_t font8x8_basic[256][8] = {
    ...
    {0x7E,0x81,0xA5,0x81,0xBD,0x99,0x81,0x7E}, // 1 (Smiley)
    {0x7E,0xFF,0xDB,0xFF,0xC3,0xE7,0xFF,0x7E}, // 2 (Solid Smiley)
    {0x6C,0xFE,0xFE,0xFE,0x7C,0x38,0x10,0x00}, // 3 (Heart)
    {0x10,0x38,0x7C,0xFE,0x7C,0x38,0x10,0x00}, // 4 (Diamond)
    {0x38,0x7C,0x38,0xFE,0xFE,0x7C,0x38,0x7C}, // 5 (Club)
    {0x10,0x10,0x38,0x7C,0xFE,0x7C,0x38,0x7C}, // 6 (Spade)
    {0x00,0x00,0x18,0x3C,0x3C,0x18,0x00,0x00}, // 7 (Dot)
    {0xFF,0xFF,0xE7,0xC3,0xC3,0xE7,0xFF,0xFF}, // 8 (Inv Dot)
    {0x00,0x3C,0x66,0x42,0x42,0x66,0x3C,0x00}, // 9 (Circle)
    {0xFF,0xC3,0x99,0xBD,0xBD,0x99,0xC3,0xFF}, // 10 (Inv Circle)
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, // ... skipping to ASCII ...
    ...
    {0x00,0x00,0x60,0x30,0x18,0x0C,0x06,0x00}, // 47 /
    ...
    {0x00,0x00,0x66,0x66,0x66,0x3E,0x18,0x00}, // 118 v
    {0x00,0x00,0xD6,0xD6,0xD6,0x7C,0x28,0x00}, // 119 w
