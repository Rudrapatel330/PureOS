...
isr_common_stub:
    ...
    mov rdi, rsp   ; Pass registers_t pointer as first argument (SysV ABI)
    call isr_handler
    mov rsp, rax   ; SWITCH STACK if a context switch occurred
...
irq_common_stub:
    ...
    mov rdi, rsp   ; Pass registers_t pointer as first argument
    call irq_handler
    mov rsp, rax   ; SWITCH STACK if a context switch occurred
