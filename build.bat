...
.\tools\bin\x86_64-elf-gcc.exe -ffreestanding -mno-red-zone -mno-mmx -O2 -Wall -Wextra -mcmodel=large -c src/drivers/ac97.c -o build/ac97.o -Iinclude -Isrc/drivers -Isrc/kernel -Isrc/kernel/hal
if %errorlevel% neq 0 exit /b %errorlevel%
...
.\tools\bin\x86_64-elf-gcc.exe -ffreestanding -mno-red-zone -mno-mmx -O2 -Wall -Wextra -mcmodel=large -c src/lib/tinyexpr.c -o build/tinyexpr.o -Iinclude -Isrc/lib
if %errorlevel% neq 0 exit /b %errorlevel%
...
.\tools\bin\x86_64-elf-gcc.exe -ffreestanding -mno-red-zone -mno-mmx -O2 -Wall -Wextra -Wno-override-init -mcmodel=large -c src/gui/explorer_icons.c -o build/explorer_icons.o -Iinclude -Isrc/kernel -Isrc/kernel/hal -Isrc/drivers -Isrc/gui
if %errorlevel% neq 0 exit /b %errorlevel%
...
.\tools\bin\x86_64-elf-gcc.exe -ffreestanding -mno-red-zone -mno-mmx -O2 -Wall -Wextra -mcmodel=large -c src/apps/phone.c -o build/phone.o -Iinclude -Isrc/kernel -Isrc/kernel/hal -Isrc/drivers -Isrc/gui -Isrc/apps -Isrc/net
if %errorlevel% neq 0 exit /b %errorlevel%

echo Compiling Recorder App...
.\tools\bin\x86_64-elf-gcc.exe -ffreestanding -mno-red-zone -mno-mmx -O2 -Wall -Wextra -mcmodel=large -c src/apps/recorder.c -o build/recorder.o -Iinclude -Isrc/kernel -Isrc/kernel/hal -Isrc/drivers -Isrc/gui -Isrc/apps
if %errorlevel% neq 0 exit /b %errorlevel%

echo Compiling Audio Test App...
.\tools\bin\x86_64-elf-gcc.exe -ffreestanding -mno-red-zone -mno-mmx -O2 -Wall -Wextra -mcmodel=large -c src/apps/audio_recv_test.c -o build/audio_recv_test.o -Iinclude -Isrc/kernel -Isrc/kernel/hal -Isrc/drivers -Isrc/gui -Isrc/apps -Isrc/net
if %errorlevel% neq 0 exit /b %errorlevel%
...
.\tools\bin\x86_64-elf-gcc.exe -ffreestanding -mno-red-zone -mno-mmx -Os -Wall -Wextra -mcmodel=large -c src/apps/browser/duktape.c -o build/duktape.o -Iinclude -Isrc/kernel -Isrc/kernel/hal -Isrc/apps/browser
if %errorlevel% neq 0 exit /b %errorlevel%

.\tools\bin\x86_64-elf-gcc.exe -ffreestanding -mno-red-zone -mno-mmx -O2 -Wall -Wextra -mcmodel=large -c src/apps/browser/js.c -o build/js.o -Iinclude -Isrc/kernel -Isrc/kernel/hal -Isrc/drivers -Isrc/gui -Isrc/apps -Isrc/apps/browser
if %errorlevel% neq 0 exit /b %errorlevel%
